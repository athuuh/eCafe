  ...
  <!-- ========== END HEADER ========== -->
						...
						<!--  Header End -->
									...
									<div class="card-body">
										...
										<div class="relative overflow-x-auto">
											...
											<table class="text-left w-full whitespace-nowrap text-sm text-gray-500">
												<thead>
													<tr class="text-sm">
														<th scope="col" class="p-4 font-semibold">Product id</th>
														<th scope="col" class="p-4 font-semibold">Product name</th>
                            ...
                            <th scope="col" class="p-4 font-semibold">Price</th>
														...
														<th scope="col" class="p-4 font-semibold"></th>
													</tr>
												</thead>
												<tbody>
                          <?php
														...
														<td class="p-4 text-sm">
															<div class="flex gap-6 items-center">
																...
																<div class="flex flex-col gap-1 text-gray-500">
																	<h3 class=" font-bold"><?php echo $res['pid'];?></h3>
																</div>
															</div>
														</td>
														<td class="p-4">
															<h3 class="font-medium"><?php echo $res['pname'];?></h3>
														</td>
														<td class="p-4">
															<h3 class="font-medium text-teal-500"><img src="<?php echo $res['image'];?>" width="70px"></h3>
														</td>
                            <td class="p-4">
															<h3 class="font-medium text-teal-500"><?php echo $res['stock'];?></h3>
														</td>
                            <td class="p-4">
															<h3 class="font-medium text-teal-500"><?php echo $res['price'];?></h3>
                            </td>
                            <td class="p-4">
															<h3 class="font-medium text-teal-500"><?php echo $res['description'];?></h3>
                            </td>
                            <td class="p-4">
															<h3 class="font-medium text-teal-500"><a href="editproduct.php?id=<?php echo $res['pid'];?>">Edit</a></h3>
                            </td>
                            <td class="p-4">
															<h3 class="font-medium text-teal-500"><a href="deleteproduct.php?id=<?php echo $res['pid'];?>">Delete</a></h3>
                            </td>
